...
class TrackProfile extends React.Component<ITrackProfileProps, any> {
  ...
  componentWillMount() {
    ...
    colorThief.getColorFromUrl(bigPic, palettes => {
  ...
  render() {
    ...
    let isCurrentTrackPlaying =
      playerStore.isPlaying && isEqual(playerStore.playingTrack, track);
      ...
      <div className={styles.view}>
        ...
        <div className={styles.infos}>
          <div className={styles.artwork_wrapper}>
            ...
            <div
              style={{
                animationPlayState: isCurrentTrackPlaying ? 'running' : 'paused'
              }}
            ...
            >
              <span
                ...
                style={{
                  backgroundImage: `url(${bigPic
                    ? getSpecPicPath(bigPic, PicSize.MASTER)
                    : preImage})`
                }}
              />
            </div>
          ...
          <div className={styles.artwork_infos}>
            ...
            >
              <i
                className={`fa fa-${isCurrentTrackPlaying
                  ? 'pause fa-2x'
                  : 'play fa-3x'}`}
              />
            </ButtonInline>
            <div className={styles.infos_operators}>
              <div className={styles.infos_title}>

                <HomeLink id={id} clazz={styles.userlink}>
                  {username}
                </HomeLink>
                <h1>
