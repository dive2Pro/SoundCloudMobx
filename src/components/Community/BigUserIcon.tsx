...
@observer
export default class BigUserPic extends React.PureComponent<
  IBigUserPicProps,
  {}
> {
  render() {
    ...
    const artworksize = performanceStore
      ? performanceStore.getSizeWithSpecWidth(180, 180, 140, 100)
      : 180;
    return (
      <div className={styles.bigpic}>
        ...
        >
          <ArtWork style={style} src={avatar_url} size={artworksize} />
        </Link>
        ...
        <div className={styles.toggle}>
          <ButtonGhost onClick={handleFollow}>
