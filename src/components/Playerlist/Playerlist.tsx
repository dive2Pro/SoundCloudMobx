...
const PlaylistItem = observer(
  ({performanceStore, track, store}: IPlaylistItemProp) => {
    ...
    const configurations = [
      ...
      {
        fn: () => {
          store.removeFromPlaylist(track);
        },
    ...
    return (
      <div className={styles.playlistitem}>
        ...
        />
        <div className={styles.playlistitem_hover}>
          <HoverActions isVisible={!isHidden} configurations={configurations} />
        </div>
      </div>
    );
  }
