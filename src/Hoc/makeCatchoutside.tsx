...
export default function makeCatchoutside<Props>(
  Cons: new (Props?: any | undefined, context?: any) => React.Component<
    Props,
    any
  >
) {
  if (
    typeof Cons === 'function' &&
    (!Cons.prototype || !Cons.prototype.render) &&
    !React.Component.isPrototypeOf(Cons)
  ) {
    return makeCatchoutside(
      class TempCons extends Component<Props, any> {
        render() {
          return Cons.call(this, this.props, this.context);
        }
      }
    );
  }
