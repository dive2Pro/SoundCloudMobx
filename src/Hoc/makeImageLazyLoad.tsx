...
function makeImageLazyLoad<Props, State>(
  Comp:
    | React.ComponentClass<Props & {src: string}>
    | React.StatelessComponent<Props & {src: string}>
): React.ComponentClass<Props> {
  @inject(PERFORMANCE_STORE)
  @observer
  class MakeImageLazyLoadWrapper extends React.PureComponent<
    Props & IMakeImageLazyLoadWrapperProps,
    {}
  > {
    ...
    render() {
      return <Comp {...this.props} src={this.imageSrc} />;
    }
  }
