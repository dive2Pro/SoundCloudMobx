...
export class PlayerStore {
  ...
  @action
  setPlayingTrack(track: ITrack | number) {
  ...
  @action
  removeFromPlaylist(...tracks: ITrack[]) {
    tracks.forEach(t => {
  ...
  @action
  togglePlaylistOpen(open?: boolean) {
    if (open != null) {
  ...
  @action
  private pushToPlayerlist(t: ITrack) {
